...
/* ------------------ Intersection Using Two-Pointer Switching ------------------ */
Node *getIntersection(Node *head1, Node *head2) {
    ...
    while (temp1 != temp2) {
        temp1 = (temp1 != nullptr) ? temp1->next : head2;
        temp2 = (temp2 != nullptr) ? temp2->next : head1;
    }

    return temp1; /* returns intersection node or nullptr if no intersection */
}
